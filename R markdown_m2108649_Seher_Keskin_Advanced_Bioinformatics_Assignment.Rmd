...
## y variable represents distance in feet.
...
b <- c +ggtitle("Linear fit of the relationship between breaking distance(dist) and speed")+ xlab("speed(milesperhour-mph)")+ ylab("dist(feet-ft)")
b
```
